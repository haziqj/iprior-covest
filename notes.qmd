...
$$
\Theta \mid y \sim \mathcal W (HW_0H + nS, \nu + n).
$$
which suggests that
$$
W \mid y \sim \mathcal W \big( W_0 + nH^{-1}SH^{-1}, \nu + n \big)
$$
...
$$
Which means we could choose the observed information instead, so setting $W_0 = S^{-1}$.
